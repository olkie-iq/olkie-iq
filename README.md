...
| <img src="https://capsule-render.vercel.app/api?type=waving&color=00000000&height=100&section=header" /> |
| :--- |
| <div style="margin-top: -90px;"> <h1>Hi, I'm olkie 👋</h1> </div> |
...
const olkie = {
  ...
  founder: "Olkie World",
  certificates: [
    "Million AI Prompters - Dubai Future Foundation",
    "Elements of AI"
  ],
  specialties: ["C++", "Node.js", "Flutter", "Firebase", "Prompt Engineering"],
  motto: "Building immersive digital experiences and optimizing AI workflows"
};
```
---
### 🧰 Tech Toolbox
